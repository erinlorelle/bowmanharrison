        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div id="buy" class="post-preview">
                        ...
                        <h4 style="color: dimgrey; text-align: center;">
                            <em>Home sales are all about the details!</em>
                        </h4>
                        <ol>
                ...
                <hr>
                <div id="sell" class="post-preview">
                    <h2 style="text-align: center;">
                    Home Selling Guide
                    </h2>
                    <h4 style="color: dimgrey; text-align: center;">
                ...
                <div id="stage" class="post-preview">
                        ...
                        <h4 style="color: dimgrey; text-align: center;">
                            <em>Staging sells properties faster and we provide professional results!</em>
                        </h4>
                        <ul>
                        ...
                        <h4 style="color: dimgrey; text-align: center;">
                            <em>What staging can do for your home:</em>
                        </h4>
                        <ul>
